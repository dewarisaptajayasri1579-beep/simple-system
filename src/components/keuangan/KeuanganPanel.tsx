...
import { ArrowUpRight, ArrowDownLeft, Wallet, Tags, ArrowLeftRight, PieChart, History, HandCoins } from "lucide-react";
...
export const KeuanganPanel: React.FC = () => {
  const menuCards = [
    ...
    },
    {
      ...
      title: "Kasbon Tim",
      description: "Catat kasbon karyawan & pelunasannya",
