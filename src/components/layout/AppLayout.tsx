...
export const AppLayout: React.FC<AppLayoutProps> = ({ children, userName, userRole }) => {
  ...
  return (
    <div className="app-shell min-h-screen bg-app-mesh text-slate-800 font-sans flex relative overflow-x-clip">
      ...
      <div
        className={`app-shell-content flex-1 flex flex-col min-w-0 transition-all duration-300 ${isSidebarCollapsed ? "lg:pl-20" : "lg:pl-64"}`}
      >
        <div className="no-print contents">
