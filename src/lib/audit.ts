 ...
 *
 * Versi neutral (non-marketing) dari `lib/marketing/audit.ts` — dipakai fitur di luar modul
 * Marketing (mis. Administratif) supaya tidak import dari namespace marketing.
 *
