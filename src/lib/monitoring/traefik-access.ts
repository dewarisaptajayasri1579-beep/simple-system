...
/** Ambil timestamp request terakhir per domain dari log akses container reverse proxy Coolify
...
export async function getLastAccessedByDomain(vps: VpsProxyLike, domains: string[]): Promise<Map<string, Date>> {
