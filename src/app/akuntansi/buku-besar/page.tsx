...
export default async function BukuBesarPage({ searchParams }: { searchParams: Promise<{ accountId?: string; month?: string }> }) {
  // Owner+Direktur saja — role "admin" sudah tidak boleh masuk Akuntansi sama sekali, jadi
  // filter per-akun COA (RoleCoaAccess) tidak dipakai lagi di sini. Gate ini sekarang sama
  // dengan GET /api/akuntansi/buku-besar yang dari dulu memang owner/direktur saja.
