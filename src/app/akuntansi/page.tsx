      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 font-medium mt-1">Pembukuan double-entry (jurnal debit/kredit) — Pendapatan diakui saat uang benar-benar masuk.</p>
          </div>
        </div>
