      ...
      <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <PengaturanPanel
          ...
          settings={{
            ...
            paymentBankNameIntl: settings.paymentBankNameIntl,
            paymentBankBranchIntl: settings.paymentBankBranchIntl,
            paymentSwiftCodeIntl: settings.paymentSwiftCodeIntl,
            paymentAccountNameIntl: settings.paymentAccountNameIntl,
            paymentAccountNumberIntl: settings.paymentAccountNumberIntl,
